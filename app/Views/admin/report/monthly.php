...
<p class="pageTitle fs-5">Monthly Report</p>
</div>
...
<div class="row">
<div class="col-md-12">
<?php echo form_open_multipart(site_url($prePath.'report/monthly'),array('name'=>'searchForm','class'=>'form row justify-content-start','method'=>'GET'));?>
...
<div class="card">
  <div class="card-body">
	...
	<th scope="col" style="width:30%;">Doctor Name</th>
	<th scope="col" style="width:15%;">Total Service</th>
	<th scope="col" style="width:15%;">Amount</th>
	<th scope="col" style="width:15%;">Commission</th>
	<th scope="col" style="width:15%;">Earning</th>
	</tr>
	</thead>
	<tbody>
	<?php
