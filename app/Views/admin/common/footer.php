...
<div class="col-md-6 col-5 text-start text-white"><a href="#" class="text-white text-decoration-none">Global Surgeons Summit <span class="fw-bold"><?php echo date("Y");?></span></a></div>
